...
<html>
<head>
    <title>Select Restaurant Item to Delete</title>
    <link rel="stylesheet" href="css/admin_resort.css">
</head>
<body>
    <h1>Select Restaurant Item to Delete</h1>
    <div class="container">
    <form action="delete_restaurant_item.php" method="post">
        <label for="item_id">Select Restaurant Item to Delete:</label>
